...
$total_users = count($pdo->read("access"));
$total_duties_in_progress = count($pdo->read("duties", ['status' => 'In Progress']));
$total_site_registerd = count($pdo->read("site_registration", ['status' => 'Approved']));
$total_countries = count($pdo->read("countries"));
                        ...
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    ...
                                    <h4 class="ad-card-title"><?php echo $total_users; ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title">Total duties in progress</h5>
                                    <h4 class="ad-card-title"><?php echo $total_duties_in_progress; ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title">Total site registed</h5>
                                    <h4 class="ad-card-title"><?php echo $total_site_registerd; ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title">Total countries</h5>
                                    <h4 class="ad-card-title"><?php echo $total_countries; ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
