            ...
            if ($pdo->validateInput($_POST['mobile'], 'phone')) {
                if ($pdo->validateInput($_POST['emergency_contact_number'], 'phone')) {
                    if ($pdo->validateInput($_POST['email'], 'email')) {
                        if ($pdo->validateInput($_POST['cnic'], 'brpn')) {
                                                    ...
                                                    if (strlen($_POST['pasport']) == 10) {
                                                        if (strlen($_POST['topic_answer']) >= 300 && strlen($_POST['topic_answer']) <= 500) {
                                                            ...
                                                            if (!$pasport_front_pic_result) {
                                                                ...
                                                                if ($pdo->create("registration", ['firstname' => $_POST['firstname'],
                                                                ...
                                                                'part' => $_POST['part'],
                                                                'availability' => $day,
                                                                'status' => "Pending"]) && $pdo->create("access", ['user_id'=>$idCreated])
                                                                ) {
                            ...
                            $error = "BRPN is not in correct form.";
                        }
                    } else {
                                            ...
                                            <div class="col-md">
                                                <div class="form-group">
                                                    ...
                                                    <input
                                                        ...
                                                        class="form-control" name="password" type="tel"
